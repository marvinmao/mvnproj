...
public class DaoTest {
    ...
    public void updateTest() {
        ...
        updateCriteria.andFileUrlEqualTo("group1/M00/00/00/wKhJjFwMyBOAEvR2AAFBO0Km5pM59.docx");
        FdfsFileTbl fdfsFileTbl = new FdfsFileTbl();
        short deleteFlag = 0;
        fdfsFileTbl.setDeleteFlag(deleteFlag);
//        int updateByExampleSelective = fdfsFileTblMapper.updateByExampleSelective(fdfsFileTbl, criteria);
//        System.out.println("updateByExampleSelective [" + updateByExampleSelective + "]");
    }
}
